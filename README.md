...
Medical History: Splits medical history into diseases, converts to lowercase, and maps to risk scores.
Normalization: Normalizes risk scores to ensure all values are on a comparable scale.
Scaling Function
